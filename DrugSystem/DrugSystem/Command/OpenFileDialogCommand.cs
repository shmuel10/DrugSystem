        ...
        public void Execute(object parameter)
        {
            ...
            if (op.ShowDialog() == true)
            {
                if (CurrentVM is AddNewDoctorUC_VM)
                {
                    ...
                    string picturePath = @"..\..\Images\UsersPicture" + @"\" + doctorID + @".JPG";
                ...
                else if (CurrentVM is AddNewMedicineUC_VM)
                {
                    ...
                    string picturePath = @"..\..\Images\MedsPicture" + @"\" + medID + @".JPG";
                ...
                }else if(CurrentVM is AddNewOfficerUC_VM)
                {
                    ...
                    string picturePath = @"..\..\Images\UsersPicture" + @"\" + officerID + @".JPG";
